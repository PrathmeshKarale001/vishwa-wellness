...
>(({ className, children, ...props }, ref) => (
    <DrawerPortal>
        ...
        <DrawerPrimitive.Content
            ref={ref}
            className={cn(
                "fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-3xl border border-stone-200 bg-white",
                className
            )}
            {...props}
        >
...
const DrawerFooter = ({
    ...
    <div
        className={cn(
            "mt-auto flex flex-col gap-2 p-4 pt-2 border-t border-stone-100",
            className
        )}
        {...props}
    />
