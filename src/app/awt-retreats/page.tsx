...
const retreats = [
    {
        id: "3-day",
        duration: "3 Days",
        title: "Pain & Stress Reset",
        price: "₹45,000",
        image: "/package-1.jpg",
        description: "An intensive weekend retreat focused on releasing physical pain and mental stress through fire ceremonies and ash therapies.",
        highlights: [
            "Daily fire ceremonies at sunrise",
            "Full-body Bhasma Snān sessions",
            "Stress release breathwork",
            "Ayurvedic meals included",
            "Take-home ritual kit"
        ],
        includes: "Accommodation, meals, all ceremonies, wellness kit"
    },
    {
        id: "7-day",
        duration: "7 Days",
        ...
        price: "₹95,000",
        image: "/package-2.jpg",
        description: "A week-long deep cleanse combining fasting protocols, daily rituals, and metabolic reset techniques for complete renewal.",
        highlights: [
            "Guided juice fasting protocol",
            "Daily Bhasma rituals (all three)",
            "Ayurvedic body therapies",
            "Yoga and meditation sessions",
            "Personalized wellness plan",
            "Before/after health assessment"
        ],
        includes: "Accommodation, cleansing meals, therapies, assessments"
    },
    {
        id: "15-day",
        duration: "15 Days",
        ...
        price: "₹1,85,000",
        image: "/package-3.jpg",
        description: "Our flagship immersive experience for profound transformation. Combines all rituals, advanced practices, and personalized protocols.",
        highlights: [
            "Complete Panchakarma treatments",
            "Advanced fire ceremony initiation",
            "One-on-one wellness coaching",
            "Sacred pilgrimage experience",
            "Lifetime access to our community",
            "3-month follow-up program"
        ],
        includes: "Premium accommodation, all meals, all treatments, follow-up"
    }
];
...
export default function AWTRetreatsPage() {
    return (
        <>
            {/* Hero */}
                    ...
                    {retreats.map((retreat, index) => (
                        ...
                        >
                            <Card variant="bordered" className="h-full flex flex-col">
                                <CardImage src={retreat.image} alt={retreat.title} aspectRatio="video" />
                                <CardContent className="flex-1 flex flex-col">
                                    ...
                                    <div className="mb-6 flex-1">
                                        ...
                                        <ul className="space-y-2">
                                            {retreat.highlights.slice(0, 4).map((item) => (
